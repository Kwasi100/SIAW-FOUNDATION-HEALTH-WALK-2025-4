...
map.getView().fit([-13077699.644887, -3869284.059401, 13212348.000409, 26613254.151938], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">HEALTH WALK SIAW FOUNDATION</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Location_of_Participants_1,
    colName: 'Name',
    zoom: 10,
    collapsed: true,
    map: map,
